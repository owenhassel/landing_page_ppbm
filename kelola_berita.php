    ...
    <div class="sec" id="berita">
        ...
        <div style="overflow-x:auto;">
            <table class="dtbl">
                ...
                $total_data = mysqli_fetch_array(mysqli_query($conn, "SELECT COUNT(*) FROM berita"))[0];
                $total_page = ceil($total_data / $limit);
                if ($total_page == 0) { $total_page = 1; }

                $q = mysqli_query($conn, "SELECT * FROM berita ORDER BY date DESC LIMIT $offset, $limit");
